                 ...
                 <div class="border">
                   ...
                   <?php 
                                                          ...
                                                          <div class="row">
                                                              <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <button type="submit" class="btn btn-block btn-danger p-lg-left-right" onclick="delete()"> Delete </button>
                                                                </div>
                                                              </div>
                                                               <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <button type="submit" class="btn btn-block btn-primary p-lg-left-right" onclick="submitMarks()"> Update </button>
                                                                </div>  
                                                              </div>
                                                           </div>
                                                       </div>
                       ...
                       //  if(isset($_REQUEST['Ccode'])){ $_SESSION['ccode'] = $_REQUEST['Ccode']; assign($_SESSION['ccode']); }
                         if(isset($_REQUEST['code'])){  $id = $_SESSION['id'];$ccode = $_REQUEST['code'];  preview($id,$ccode); }
